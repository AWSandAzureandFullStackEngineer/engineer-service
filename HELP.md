...
* The original package name 'net.central.hub.engineers.engineers-service' is invalid and this project uses 'net.central.hub.engineers.engineersservice' instead.
